from src.model.repositories.subscribers_repository import SubscribersRepositoryInterface
...
class SubscribersCreator:
    ...
    def create(self, http_request: HttpRequest) -> HttpResponse:
        ...
        self.__check_subscriber(subscriber_email, evento_id)
        self.__insert_subscriber(subscriber_info)
        return self.__format_response(subscriber_info)
    
    def __check_subscriber(self, subscriber_email: str, evento_id: int) -> None:
